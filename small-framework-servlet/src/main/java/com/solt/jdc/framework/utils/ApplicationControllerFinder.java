package com.solt.jdc.framework.utils;
...
public class ApplicationControllerFinder {
    ...
    private IController getControllerInstance(Class<IController> controller){
        try{
            ...
            throw new RuntimeException(String.format("Error occured while creating instance of controller %s: %s ", controller.getSimpleName(), e.getMessage()));
        }
    }
