...
import com.solt.jdc.annotationcontrollermethod.ds.Country;
import com.solt.jdc.annotationcontrollermethod.ds.Person;
import com.solt.jdc.annotationcontrollermethod.storage.InMemoryStorage;
...
public class Example07RequestPart {
    ...
    public String example07D(@RequestPart("person") @Valid Person person, BindingResult bindingResult){
        return String.format("Received person = [%s], error counts = [%d] \n", person, bindingResult.getErrorCount());
    }

    // http://localhost:8080/example07E/gallery
