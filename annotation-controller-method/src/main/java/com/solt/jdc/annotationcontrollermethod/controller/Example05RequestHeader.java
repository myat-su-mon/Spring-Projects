...
public class Example05RequestHeader {
    ...
    // curl -H "Accept-Version: 2.1" http://localhost:8080/example05A
    ...
    // curl -H "Accept-Version: 2.1" http://localhost:8080/example05B
    ...
    // curl -H "Accept-Version: 2.1" http://localhost:8080/example05C
    ...
    // curl -H "Accept-Version: 2.1" http://localhost:8080/example05D
    ...
    // curl -H "Accept-Version: 2.1" http://localhost:8080/example05E
    // curl http://localhost:8080/example05E
